...
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24"><path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801" fill="#0078d4"/></svg>',
...
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" fill="#003b57"/></svg>',
...
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24" fill="white"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" fill="#cc785c"/></svg>',
    '<img src="https://upload.wikimedia.org/wikipedia/commons/0/0e/Anthropic_logo.svg" alt="Claude" onerror="this.style.display=\'none\';this.parentNode.innerHTML=\'<div class=\'logo-placeholder\' style=\'background:#cc785c\'>C</div>Claude\'">'
)
...
# Restore placeholders for Hermes, Claw, Fireworks
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24"><rect width="24" height="24" rx="6" fill="#4f46e5"/><text x="12" y="17" font-size="12" font-weight="700" text-anchor="middle" fill="white" font-family="Arial,sans-serif">H</text></svg>',
    '<div class="logo-placeholder" style="background:#4f46e5">H</div>'
)
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24"><rect width="24" height="24" rx="6" fill="#ea580c"/><text x="12" y="17" font-size="12" font-weight="700" text-anchor="middle" fill="white" font-family="Arial,sans-serif">C</text></svg>',
    '<div class="logo-placeholder" style="background:#ea580c">C</div>'
)
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24"><rect width="24" height="24" rx="6" fill="#ff4f00"/><text x="12" y="17" font-size="10" font-weight="700" text-anchor="middle" fill="white" font-family="Arial,sans-serif">F</text></svg>',
    '<div class="logo-placeholder" style="background:#ff4f00">F</div>'
)

# Tech Stack - restore original placeholders
html = html.replace(
    '<svg width="28" height="28" viewBox="0 0 24 24"><rect width="24" height="24" rx="2" fill="#F7DF1E"/><text x="12" y="17" font-size="10" font-weight="700" text-anchor="middle" fill="black" font-family="Arial,sans-serif">JS</text></svg>',
    '<div class="logo-placeholder" style="background:#f7df1e;color:#000">JS</div>'
)
...
html = html.replace(
    ...
    '<div class="logo-placeholder" style="background:#181717">GH</div>'
)
