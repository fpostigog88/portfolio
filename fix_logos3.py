...
# Replace all img tags with inline SVGs using regex that handles the onerror attribute
# Infrastructure
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/3/35/Tux\.svg"[^>]*>',
    LINUX_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/e/e6/Windows_11_logo\.svg"[^>]*>',
    WINDOWS_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/9/97/Sqlite-square-icon\.svg"[^>]*>',
    SQLITE_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/4/4e/Docker_\(%container_engine%\)_logo\.svg"[^>]*>',
    DOCKER_SVG,
    html
)
...
# Productivity
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/3/34/Microsoft_Office_Excel_\(%282019%E2%80%93present%\)29\.svg"[^>]*>',
    EXCEL_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/0/0d/Microsoft_Office_PowerPoint_\(%282019%E2%80%93present%\)29\.svg"[^>]*>',
    PPT_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/f/fd/Microsoft_Office_Word_\(%282019%E2%80%93present%\)29\.svg"[^>]*>',
    WORD_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/c/c3/Python-logo-notext\.svg"[^>]*>',
    PYTHON_SVG,
    html
)
...
# AI & Cloud
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/4/4d/OpenAI_Logo\.svg"[^>]*>',
    OPENAI_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/0/0e/Anthropic_logo\.svg"[^>]*>',
    ANTHROPIC_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/c/cf/New_Power_BI_Logo\.svg"[^>]*>',
    POWERBI_SVG,
    html
)
...
# Work & Education
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/4/48/Dell_Logo\.svg"[^>]*>',
    DELL_SVG,
    html
)
html = re.sub(
    r'<img src="https://upload\.wikimedia\.org/wikipedia/commons/f/fb/Michigan_Wolverines_logo\.svg"[^>]*>',
    MICHIGAN_SVG,
    html
)
...
# Count remaining placeholders (excluding the CSS class definition)
